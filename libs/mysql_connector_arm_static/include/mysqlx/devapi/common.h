  ...
  namespace internal
  {
    ...
    */
      ...
      */
      ...
      template <
          typename U, typename std::enable_if<
                          !std::is_same<U, std::initializer_list<typename U::value_type>>::value>::type * = nullptr>
      operator U()
      {
        try
        {
    ...
    struct iterator_traits
    {
      ...
      using reference = typename std::iterator_traits<value_type *>::reference;
    };
    ...
    */
    ...
    public:
      static const bool value = std::is_same<
          std::true_type,
          decltype(test<C>(nullptr, nullptr))>::value;
    };
